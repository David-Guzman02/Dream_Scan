...
'''
print(f"{BLUE}/////////////////////////////////////////////////////////////////////////////////////////{END}")
print(f"{BLUE}////{END}{YELLOW}                           DREAM SCAN 0.0.1                                     {END}{BLUE}////{END}")
print(f"{BLUE}////{END}{YELLOW}                   Active reconaissance made simple                            {END}{BLUE}////{END}")
print(f"{BLUE}////                                                                              ////{END}")
print(f"{BLUE}////{END}{YELLOW} Written by: David Guzman, Jacob Guerrero, Kuan Chen, Sean Pacurucu Caminero {END}{BLUE}////{END}")
print(f"{BLUE}////                                                                            ////{END}")
print(f"{BLUE}///////////////////////////////////////////////////////////////////////////////////{END}")
print('''
''')
